  ...
  return (
    <>
      <div className="flex align-middle justify-center cursor-pointer">
        <input
          type="text"
          className="bg-slate-600 border border-slate-500 text-slate-200 placeholder-slate-400 text-md focus:border-slate-400 block w-64 p-2 focus:outline-none rounded-lg shadow-\
          "
